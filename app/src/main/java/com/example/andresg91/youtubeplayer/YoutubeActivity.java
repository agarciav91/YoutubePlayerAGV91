...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyCaNXp-f9KgJS70G_TeSzVbvfxImMB45Ws";
    static final String YOUTUBE_VIDEO_ID = "LNDWncpPvPc";
    static final String YOUTUBE_PLAYLIST = "RDMMscyA7iVogLQ";
...
//        ConstraintLayout constraintLayout = (ConstraintLayout) findViewById(R.id.activity_youtube);
        ...
        /*
         this is how you add a Widget to a View programatically
        Button btn1 = new Button(this);
        btn1.setLayoutParams(new ConstraintLayout.LayoutParams(500, 100));
